...
import { acceptBooking, getBookingRequests, rejectBooking } from '../Services/FetchBookedRooms';
// import { 
//   getBookingRequests,
//   acceptBooking,
//   rejectBooking 
...
const BookedRoomsPage = () => {
  ...
  const handleAccept = async (bookingId) => {
    try {
      ...
      const updatedBookings = await getBookingRequests();
                ...
                {booking.responseMessage && (
                  <div className="mt-4 p-3 bg-gray-50 rounded">
                    <p className="text-sm text-gray-700">
                      <span className="font-medium">Your response:</span> {booking.responseMessage}
                    </p>
                  </div>
                )}
              </div>
