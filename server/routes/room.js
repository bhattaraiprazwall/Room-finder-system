...
router.put("/update/:roomId", authAdmin,upload.fields([{ name: 'frontimg', maxCount: 1 }, { name: 'video', maxCount: 1 }]), roomCtrl.updateRoom)
router.delete("/delete/:roomId",authAdmin, roomCtrl.deleteRoom)
